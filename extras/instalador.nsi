...
;General
  ...
  ;Name and file
  Name "Pilas Bloques"
  OutFile "pilas-compositor-de-grillas.exe"

  ;Default installation folder
  InstallDir "c:\pilas-compositor-de-grillas"

  ;Get installation folder from registry if available
  InstallDirRegKey HKCU "pilas-compositor-de-grillas\pilas-compositor-de-grillas" ""
...
Section "Dummy Section" SecDummy
  ...
  WriteRegStr HKCU "pilas-compositor-de-grillas\pilas-compositor-de-grillas " "" $INSTDIR
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortCut "$SMPROGRAMS\$StartMenuFolder\pilas-compositor-de-grillas.lnk" "$INSTDIR\pilasBloques.exe"
